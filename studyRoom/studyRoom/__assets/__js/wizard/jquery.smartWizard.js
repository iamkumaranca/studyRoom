...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        next : $('<a>'+options.labelNext+'</a>').attr("href","#").addClass("btn btn-success").attr("runat","server").attr("id", "wizard-next").attr("onClick", "click_wizard-next"),
        previous : $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("btn btn-primary"),
        finish: $('<a>' + options.labelFinish + '</a>').attr("href", "#").addClass("btn btn-default").attr("runat", "server").attr("id", "wizard-finish")
    };
