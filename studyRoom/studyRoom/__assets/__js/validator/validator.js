...
var validator = (function($){
    ...
    */
    message = {
        ...
        checked         : 'The box must be checked',
        empty           : 'The textbox is empty. Please enter a value.',
        min             : 'The input is too short.',
        max             : 'The input is too long.',
        number_min      : 'The number is too low.',
        number_max      : 'The number is too high.',
        url             : 'The URL is invalid.',
        number          : 'This is not a number.',
        email           : 'The email is invalid.',
        email_repeat    : 'The emails do not match.',
        password_repeat : 'The passwords do not match.',
        repeat          : 'The values did not match.',
        complete        : 'The input is not complete.',
